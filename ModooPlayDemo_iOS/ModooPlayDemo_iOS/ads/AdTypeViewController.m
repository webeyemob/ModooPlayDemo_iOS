...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([adType isEqualToString:@"Banner"]) {
        BannerViewController *adsTestVc = [[BannerViewController alloc] init];
        ...
        InterstitialViewController *adsTestVc = [[InterstitialViewController alloc] init];
        adsTestVc.modalPresentationStyle = UIModalPresentationFullScreen;
        NSDictionary *adunitDic = adArr[indexPath.row];
        adsTestVc.titleStr = [NSString stringWithFormat:@"%@ - %@", self.titleStr, adunitDic.allKeys[0]];
        adsTestVc.adUnitID = adunitDic.allValues[0];
        ...
        RewardedVideoViewController *adsTestVc = [[RewardedVideoViewController alloc] init];
        adsTestVc.modalPresentationStyle = UIModalPresentationFullScreen;
        NSDictionary *adunitDic = adArr[indexPath.row];
        adsTestVc.titleStr = [NSString stringWithFormat:@"%@ - %@", self.titleStr, adunitDic.allKeys[0]];
        adsTestVc.adUnitID = adunitDic.allValues[0];
        ...
        FeedListViewController *adsTestVc = [[FeedListViewController alloc] init];
        adsTestVc.modalPresentationStyle = UIModalPresentationFullScreen;
        NSDictionary *adunitDic = adArr[indexPath.row];
        adsTestVc.titleStr = [NSString stringWithFormat:@"%@ - %@", self.titleStr, adunitDic.allKeys[0]];
        adsTestVc.adUnitID = adunitDic.allValues[0];
        ...
        SplashViewController *adsTestVc = [[SplashViewController alloc] init];
        adsTestVc.modalPresentationStyle = UIModalPresentationFullScreen;
        NSDictionary *adunitDic = adArr[indexPath.row];
        adsTestVc.titleStr = [NSString stringWithFormat:@"%@ - %@", self.titleStr, adunitDic.allKeys[0]];
        adsTestVc.adUnitID = adunitDic.allValues[0];
