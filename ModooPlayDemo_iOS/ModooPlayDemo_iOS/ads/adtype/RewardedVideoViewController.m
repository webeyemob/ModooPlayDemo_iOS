...
@interface RewardedVideoViewController () <TXADRewardedVideoAdDelegate>
...
#pragma mark - TXADRewardedVideoAdDelegate
- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd
             didReceiveAd:(TXADILineItem *)lineItem {
    NSLog(@"txAdRewardedVideo:didReceiveAd");
...
- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd didFailToReceiveAdWithError:(TXADAdError *)adError {
    NSLog(@"txAdRewardedVideo:didFailToReceiveAdWithError, error: %@", [adError getMessage]);
...
- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd
                  didOpen:(TXADILineItem *)lineItem {
    NSLog(@"txAdRewardedVideo:didOpen");
}

- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd
     willLeaveApplication:(TXADILineItem *)lineItem {
    NSLog(@"txAdRewardedVideo:willLeaveApplication");
}

- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd
                 didClose:(TXADILineItem *)lineItem {
    NSLog(@"txAdRewardedVideo:didClose");
    self.showRewardBtn.enabled = NO;
}

- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd
                 didStart:(TXADILineItem *)lineItem {
    NSLog(@"txAdRewardedVideo:didStart");
}

- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd
              didComplete:(TXADILineItem *)lineItem {
    NSLog(@"txAdRewardedVideo:didComplete");
}

- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd
                didReward:(TXADILineItem *)lineItem item:(TXADRewardItem *)item {
    NSLog(@"txAdRewardedVideo didReward, RewardItem is: %@", item);
}

- (void)txAdRewardedVideo:(TXADRewardedVideoAd *)rewardedVideoAd
        didFailedToReward:(TXADILineItem *)lineItem {
    NSLog(@"txAdRewardedVideo:didFailedToReward");
}
